# 🎨 **Picture Dictionary by abhayattcc Online/offline Free** 🖼️📖  
...
This project powers **[abhayattcc.github.io/image_dictionary](https://abhayattcc.github.io/image_dictionary/)** – the **best Odia picture dictionary with speech** featuring high-quality images, instant Text-to-Speech (Odia + English + Hindi), editable entries, and a dedicated Reader Section.  
...
| **PWA + Offline Support**        | Installable app with progressive caching                                   | Works without internet |
| **100% Free & Open Source**      | No ads, no paywalls, forever free                                          | Zero cost for students |
| **Mobile-First Responsive Design** | Lightning-fast on phones, tablets & desktops                              | Learn anywhere |
| **Fast Loading + Caching**       | Shows real-time progress (“Caching resources X%”)                          | No waiting |

**Upcoming (vote in Issues):** Full search bar, alphabet navigation, dark mode, multi-language picture pairs, and 400k+ word integration from the blog.

---

## 🎯 Live Demo & Quick Access (Picture Dictionary + Blog)  

**🔗 Picture Dictionary Online Free:** [https://abhayattcc.github.io/image_dictionary/](https://abhayattcc.github.io/image_dictionary/)  
...
1. **Homepage** → Beautiful grid of Odia words with preview pictures  
2. **Click any card** → Full-screen image + definition + speech controls  
3. **Activate Speech** → Hear perfect pronunciation instantly  
4. **Edit Mode** → Personalize and save your own entries  
5. **Reader Section** → Practice like a real picture book  

*(Screenshots & GIFs added regularly – contribute yours via PR!)*
...
- **Speech:** Native Web Speech API (Odia/English/Hindi)  
- **Hosting:** GitHub Pages + PWA service worker  
- **Caching:** Offline-first with real-time progress bar  
- **Icons:** Emoji-first + lightweight design  
- **Speed:** Under 1 second load time on mobile  

Lightweight, blazing fast, and future-proof.

---

## 📥 Installation & Local Setup (Offline Use)  

```bash
# Clone & run instantly
git clone https://github.com/abhayattcc/image_dictionary.git
cd image_dictionary
open index.html   # Works 100% offline!
